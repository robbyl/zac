                            ...
                            <div class="sheet-wraper summary">
                                ...
                                <div class="section">
                                    ...
                                    <table width="100%" border="1" cellspacing="0" cellpadding="5" class="form-data-table form-summery" style="margin-bottom: 20px;">
                                        ...
                                        echo '<td>' . number_format($B01MAL1 = $B01MAL = $totalValueHP4['B01']['']['MAL']['Government primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01FEM1 = $B01FEM = $totalValueHP4['B01']['']['FEM']['Government primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01TOT1 = ($B01MAL + $B01FEM), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02MAL1 = $B02MAL = $totalValueHP4['B02']['']['MAL']['Government primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02FEM2 = $B02FEM = $totalValueHP4['B02']['']['FEM']['Government primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02TOT1 = ($B02MAL + $B02FEM), 0, ".", ",") . '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        ...
                                        echo '<td>' . number_format($B01MAL2 = $B01MAL = $totalValueHP4['B01']['']['MAL']['Government secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01FEM2 = $B01FEM = $totalValueHP4['B01']['']['FEM']['Government secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01TOT2 = ($B01MAL + $B01FEM), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02MAL2 = $B02MAL = $totalValueHP4['B02']['']['MAL']['Government secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02FEM2 = $B02FEM = $totalValueHP4['B02']['']['FEM']['Government secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02TOT2 = ($B02MAL + $B02FEM), 0, ".", ",") . '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        ...
                                        echo '<td>' . number_format($B01MAL3 = $B01MAL = $totalValueHP4['B01']['']['MAL']['Private primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01FEM3 =$B01FEM = $totalValueHP4['B01']['']['FEM']['Private primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01TOT3 = ($B01MAL + $B01FEM), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02MAL3 = $B02MAL = $totalValueHP4['B02']['']['MAL']['Private primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02FEM3 = $B02FEM = $totalValueHP4['B02']['']['FEM']['Private primary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02TOT3 = ($B02MAL + $B02FEM), 0, ".", ",") . '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        ...
                                        echo '<td>' . number_format($B01MAL4 = $B01MAL = $totalValueHP4['B01']['']['MAL']['Private secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01FEM4 = $B01FEM = $totalValueHP4['B01']['']['FEM']['Private secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B01TOT4 = ($B01MAL + $B01FEM), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02MAL4 = $B02MAL = $totalValueHP4['B02']['']['MAL']['Private secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02FEM4 = $B02FEM = $totalValueHP4['B02']['']['FEM']['Private secondary schools'][''], 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format($B02TOT4 = ($B02MAL + $B02FEM), 0, ".", ",") . '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        echo '<td>Total</td><td>' . number_format(($B01GPSTOT + $B01GSSTOT + $B01PPSTOT + $B01PSSTOT), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B01MAL1 + $B01MAL2 + $B01MAL3 + $B01MAL4), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B01FEM1 + $B01FEM2 + $B01FEM3 + $B01FEM4), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B01TOT1 + $B01TOT2 + $B01TOT3 + $B01TOT4), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B02MAL1 + $B02MAL2 + $B02MAL3 + $B02MAL4), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B02FEM1 + $B02FEM2 + $B02FEM3 + $B02FEM4), 0, ".", ",") . '</td>';
                                        echo '<td>' . number_format(($B02TOT1 + $B02TOT2 + $B02TOT3 + $B02TOT4), 0, ".", ",") . '</td>';      
                                        echo '</tr>';
                                        ?>
                                    </table>
