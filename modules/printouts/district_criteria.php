                    ...
                    <tr>
                        ...
                        <td>
                            <select name="geoarea" id="geoarea" required="" class="select"  style="width: 99%">
                                ...
                                <option value="Micheweni">Micheweni</option>
                                <option value="Mkoani">Mkoani</option>
                                <option value="North Unguja A">North Unguja A</option>
                                <option value="North Unguja B">North Unguja B</option>
                                <option value="Unguja Central">Unguja Central</option>
                                <option value="Unguja South">Unguja South</option>
                                <option value="Unguja Urban">Unguja Urban</option>
