...
<html>
    <head>
        ...
        <title>SOFTBILL CUSTOMER INDUSTRIAL TREND</title>
    ...
    <body>
        ...
        <div class="content">
            <h1>View and Print Industrial Report</h1>
                    ...
                    <div class="sheet-wraper">
                        <div class="sheet-header">
                            <div class="header-title">
                                ...
                                <p style="font-size: 18px; font-weight: bold">CUSTOMER INDUSTRIAL REPORT</p>
                                <div class="page-logo">
