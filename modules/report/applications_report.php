        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#billing_area').change(function(){
                    ...
                    getContent('application_listing.php', {filter: $(this).val()});
                });
    ...
    <body onload="getContent('application_listing.php', {filter: $('#billing_area').val()})">
        <div class="container">
            ...
            <div class="content">
                ...
                ?>
                <h1>View Applications General Report</h1>
                ...
                <div style="margin-bottom: 15px;float: right">
                    <label> Status &nbsp;
                        <select name="status" class="select" required id="status" >
                            <option value="">--Select Application Status--</option>
                            <?php
                            require '../../config/config.php';
                            $query_status = "SELECT status FROM application ORDER BY status ASC";
