...
$query_meter_reading = "SELECT trans_date, description, rec_no, acc_no, payed_amount,
                               appnt_fullname, appln_type, billing_areas, acc_no,service,premise_status,cust_status,
                               plot_no, block_no, living_area,met_number,plot_no
                    ...
                    INNER JOIN billing_area ba
                     ...
                     INNER JOIN service_nature sev
                      ...
                      LEFT JOIN meter_status mets
                            ON met.met_status_id = mets.met_status_id
                     WHERE met_status = 'working '
...
<html>
    ...
    <body>
        ...
        <div class="content">
            <h1>View and Print Damaged Meter Report</h1>
                    ...
                    <div class="sheet-wraper">
                        <div class="sheet-header">
                            <div class="header-title">
                                ...
                                <p style="font-size: 18px; font-weight: bold">DAMAGED METER REPORT</p>
                                <div class="page-logo">
