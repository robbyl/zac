...
<?php if(!empty($tc1_volunteers_male[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[1])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[2])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[3])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[4])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[5])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[6])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[7])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_male[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'MAL', '', '" .$tc1_volunteers_male[0]. "')";  } ?>
<?php if(!empty($tc1_volunteers_female[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'VOL', 'FEM', '', '" .$tc1_volunteers_female[0]. "')";  } ?>
<?php if(!empty($tc1_staff_male[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'MAL', '', '" .$tc1_staff_male[0]. "')";  } ?>
<?php if(!empty($tc1_staff_female[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'PSF', 'FEM', '', '" .$tc1_staff_female[0]. "')";  } ?>
<?php if(!empty($tc1_employees_male[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'MAL', '', '" .$tc1_employees_male[0]. "')";  } ?>
<?php if(!empty($tc1_employees_female[8])){ $query_ans .= ",('" . $form_no . "', 'TC1', '', 'NSF', 'FEM', '', '" .$tc1_employees_female[0]. "')";  } ?>
