...
<html>
    <head>
        ...
        <title>ZANHID | EDIT FORM-4</title>
            ...
            <div class="content">
                ...
                if (isset($form_id) && !empty($form_id) && isset($lang) && !empty($lang)) {
                   ...
                   require 'sections/common_edit_query.php';
                    ...
                    ?>
                    <form action="process_edit_form4.php" method="post">
                            ...
                            <div class="section">
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="5" class="form-data-table">
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select class="select" name="shehia_name" id="shehia_name" disabled="" required style="width: 100%;">
                                                <option value=""></option>
                                                <?php
