...
$query_ans = "UPDATE tblzhafigures
 ...
 if(!empty($hp1_male_younger[5])){ $query_ans .= " WHEN FormSerialNumber = '" . $form_no . "' AND ZhaFigureCode = 'HP1' AND BreakdownTypeID1 = '$hiv_type[5]' AND BreakdownTypeID2 = '$most_risk[5]' AND BreakdownTypeID3 = 'Y25' AND BreakdownTypeID4 = 'MAL' THEN '" .$hp1_male_younger[5]. "'";  } 
 if(!empty($hp1_female_younger[5])){ $query_ans .= " WHEN FormSerialNumber = '" . $form_no . "' AND ZhaFigureCode = 'HP1' AND BreakdownTypeID1 = '$hiv_type[5]' AND BreakdownTypeID2 = '$most_risk[5]' AND BreakdownTypeID3 = 'Y25' AND BreakdownTypeID4 = 'FEM' THEN '" .$hp1_female_younger[5]. "'";  } 
 if(!empty($hp1_male_older[5])){ $query_ans .= " WHEN FormSerialNumber = '" . $form_no . "' AND ZhaFigureCode = 'HP1' AND BreakdownTypeID1 = '$hiv_type[5]' AND BreakdownTypeID2 = '$most_risk[5]' AND BreakdownTypeID3 = '25O' AND BreakdownTypeID4 = 'MAL' THEN '" .$hp1_male_older[5]. "'";  } 
 if(!empty($hp1_female_older[5])){ $query_ans .= " WHEN FormSerialNumber = '" . $form_no . "' AND ZhaFigureCode = 'HP1' AND BreakdownTypeID1 = '$hiv_type[5]' AND BreakdownTypeID2 = '$most_risk[5]' AND BreakdownTypeID3 = '25O' AND BreakdownTypeID4 = 'FEM' THEN '" .$hp1_female_older[5]. "'";  } 
 ...
 switch (substr($query_ans, '280', '1')) {

    case ',':
        $query_ans = substr_replace($query_ans, ' ', '280', '1');
        $result_ans = mysql_query($query_ans) or die(mysql_error());
        break;
 ...
 if(!empty($me1a)){ $query_ansm .= " WHEN FormSerialNumber = '" . $form_no . "' AND ZhaQuestionCode = 'ME1a' THEN '" . $me1a . "'"; } 
     ...
     if (strpos($query_ansm, 'WHEN') !== false) {
...
$query_ansm = "INSERT IGNORE INTO tblzhaanswers
 ...
 if(!empty($me1c)){ $query_ansm .= ",('" . $form_no . "', 'ME1c', '', '" . $me1c . "', '')"; } 
  ...
  switch (substr($query_ansm, '176', '1')) {

    case ',':
        $query_ansm = substr_replace($query_ansm, ' ', '176', '1');
        $result_ansm = mysql_query($query_ansm) or die(mysql_error());
        break;
 ...
 if($result_submitted){
     ...
     header("Location: edit_form4.php?form_id=" . $form_no . "&lang=" . $lang);
 }  else {
