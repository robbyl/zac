                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="role[]" class="select" required="required">
                                                ...
                                                <option <?php if ($row['role'] === 'ACCOUNTANT') echo 'selected' ?> value="CASHIER">Accountant</option>
                                                ...
                                                <option <?php if ($row['role'] === 'DATA CLERK') echo 'selected=' ?> value="Data Clerk">Credit Controller</option>
