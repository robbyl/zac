    ...
    <head>
        ...
        <script type="text/javascript">
            function consumptions(){
                //var values = getElementsByName('array[]');
                            ...
                            <form action="process_meter_reading.php" method="post" name="readings" id="readings" oninput="consumptions()" >
                                <table cellpadding="0" cellspacing="0" border="0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <input type="text" name="prev_reading[]" value="<?php echo $row['reading'] ?>" disabled class="prev" >
                                        </td>
                                        <td>
                                            <input type="number" name="curr_reading[]" min="<?php echo $row['reading'] ?>" required class="number" style="width: 100px;">
                                        </td>
                                        <td><output name="cons[]" ></output></td>
                                        <td><input type="text" name="remarks[]" class="text" style="width: 250px"></td>
                                        </tr>
                                        <?php
                                        $SN++;
                                    }
